  ...
  return (
    <div className='w-[45%] mx-auto mt-[7.5rem] p-[3rem] bg-[#F7F4F2]'>
      <div className='flex flex-col'>
        ...
        <button onClick={() => signInWithGoogle()} className='flex justify-center items-center border p-2 text-xl font-bold font-mono'><FcGoogle className='mr-2 text-2xl'/> Signin with Google</button>
      </div>
